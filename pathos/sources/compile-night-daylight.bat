...
hlrad -moddir "D:\Games\Pathos Engine\pathos" -extra -compressionlevel uber_compression -bumpmaps -low -chart -blur 2.0 -smooth 150 -smooth2 60 -notexscale -minlight 1 -estimate %mapname%.map
hlrad -moddir "D:\Games\Pathos Engine\pathos" -extra -compressionlevel uber_compression -bumpmaps -low -chart -blur 2.0 -smooth 150 -smooth2 60 -daystage nightmode -notexscale -minlight 1 -estimate %mapname%.map
hlrad -moddir "D:\Games\Pathos Engine\pathos" -extra -compressionlevel uber_compression -bumpmaps -low -chart -blur 2.0 -smooth 150 -smooth2 60 -daystage daylightreturn -notexscale -minlight 1 -estimate %mapname%.map
GOTO CopyPrompt
