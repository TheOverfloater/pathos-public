...
#define HACK_VERSIONSTRING "VL30" //--vluzacn

#if !defined (HLCSG) && !defined (HLBSP) && !defined (HLVIS) && !defined (HLRAD) && !defined (RIPENT) //--vluzacn
#error "You must define one of these in the settings of each project: HLCSG, HLBSP, HLVIS, HLRAD, RIPENT"
#endif
//=====================================================================
...
#define HLRAD_MAXEXTENT //--vluzacn // this is removed because we don't want our map unable to run in HLDS.
...
#define HLRAD_FASTMODE //--vluzacn
	#endif
	#ifdef HLRAD_FinalLightFace_VL
#define HLRAD_ADJUSTTEXTURE //--vluzacn
	#endif
...
#ifdef ZHLT_XASH
#if !defined (ZHLT_TEXLIGHT) || !defined (HLRAD_LERP_VL) || !defined (HLRAD_AUTOCORING) || !defined (HLRAD_MULTISKYLIGHT) || !defined (HLRAD_FinalLightFace_VL)
