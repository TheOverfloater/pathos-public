...
mxListView::mxListView (mxWindow *parent, int x, int y, int w, int h, __int64 id)
...
{
	HIMAGELIST h = ListView_SetImageList(d_this->d_hwnd, (HIMAGELIST)himagelist, LVSIL_SMALL );
}
