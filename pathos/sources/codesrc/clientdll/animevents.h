...
extern void EV_AttachmentDirectionMuzzleFlash( const cl_entity_t *pentity, const Char* pstroptions, Int32 attachment1, Int32 attachment2 );
...
extern void EV_ViewModelMuzzleflash_UserSpecifiedAttachment( cl_entity_t* pentity, const mstudioevent_t* pevent, const Vector& position );
