...
extern bool Mod_RecursiveLightPoint( const brushmodel_t* pworld, mnode_t *pnode, const Vector &start, const Vector &end, Vector &color, Float* plightstylevalues = nullptr, byte* poutstyles = nullptr );
extern bool Mod_RecursiveLightPoint_BumpData( const brushmodel_t* pworld, mnode_t *pnode, const Vector &start, const Vector &end, Vector &ambientcolor, Vector& diffusecolor, Vector& lightdir, Float* plightstylevalues = nullptr, byte* poutstyles = nullptr );
