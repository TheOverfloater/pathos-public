...
extern void CL_CreateCableEntity( Int32 modelindex, const Vector& start, const Vector& end, Uint32 depth, Uint32 width, Uint32 numsegments, Float windx, Float windy );
extern bool CL_SetupEntityVertexLightVBO( Int32 modelindex, cl_entity_t* pentity, Int32 vlightoffset, Uint32 vertexcount, byte* plightstyles );
...
extern void CL_RocketExplosion( const Vector& origin );
